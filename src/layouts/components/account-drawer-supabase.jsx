...
export function AccountDrawerSupabase({ data = [], sx, ...other }) {
  ...
  const displayName = fullName || user?.displayName || user?.email || 'Account';
  const email = user?.email || '';
  const photoURL = user?.photoURL || _mock.image.avatar(24);
...
export default AccountDrawerSupabase;
